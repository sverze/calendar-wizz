...
import { FiX, FiEdit, FiTrash, FiClock } from "react-icons/fi";
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6 flex justify-end space-x-3">
                    <button
                      type="button"
                      onClick={onDelete}
                      className="inline-flex justify-center items-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                    >
